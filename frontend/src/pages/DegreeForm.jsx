...
export default function DegreeForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("http://127.0.0.1:8000/recommend/bsc", formData);
  ...
  const fieldCount = formData.degree_field ? 1 : 0;
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <Link 
              to="/select-level" 
              className="inline-flex items-center space-x-2 text-red-700 hover:text-red-800 font-medium group"
            >
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            >
              {/* Header Card */}
              <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-6 shadow-xl border border-red-100">
                <div className="bg-gradient-to-br from-red-500 to-rose-600 w-16 h-16 rounded-2xl flex items-center justify-center mb-4 shadow-lg">
                ...
                <p className="text-gray-600">
                  Enter your bachelor's degree details to discover suitable courses
                </p>
              </div>
            ...
            >
              <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-red-100">
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setFormData({ ...formData, degree_field: e.target.value })}
                      className="w-full px-4 py-4 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all text-lg font-medium"
                      required
                    >
                  ...
                  <motion.button
                    ...
                    type="submit"
                    disabled={loading}
                    className={`w-full bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-700 text-white font-bold py-5 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl ${
